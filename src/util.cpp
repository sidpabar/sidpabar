...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "sidpabar.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No sidpabar.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override sidpabar.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "sidpabard.pid"));
